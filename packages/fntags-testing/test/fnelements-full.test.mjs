...
describe('fnelements', () => {
  ...
  it('should create a div with the right style for a centered flex row', () => {
    ...
    expect(el.style.display).toBe('flex')
    expect(el.style['flex-direction']).toBe('row')
    expect(el.style['align-items']).toBe('center')
    expect(el.innerText).toBe('hi')
  })
